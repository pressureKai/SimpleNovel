package com.simplynovel.zekai.simplynovel.ui.pageWidget;
...
import com.simplynovel.zekai.simplynovel.ui.pageWidget.animation.AnimationProvider;
import com.simplynovel.zekai.simplynovel.ui.pageWidget.animation.CoverAnimation;
import com.simplynovel.zekai.simplynovel.ui.pageWidget.animation.NoneAnimation;
import com.simplynovel.zekai.simplynovel.ui.pageWidget.animation.SimulationAnimation;
import com.simplynovel.zekai.simplynovel.ui.pageWidget.animation.SlideAnimation;
...
public class PageWidget extends View {
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if (event.getAction() == MotionEvent.ACTION_DOWN) {
            ...
            if (!isMove) {
                cancelPage = false;
                if (downX > mScreenWidth / 5 && downX < mScreenWidth * 4 / 5 && downY > mScreenHeight / 3
                        && downY < mScreenHeight * 2 / 3) {
